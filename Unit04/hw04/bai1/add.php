...
<div class="container">
        <form action="add_process.php" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="Nhập tên mã sinh viên" name="msv">
            </div>
            
            <div class="form-group">
                <h6 for="">Họ và tên</h6>
                <input type="text" class="form-control" id="" placeholder="Nhập vào họ và tên" name="hoten">
            </div>  

            <div class="form-group">
                <h6 for="">Số điện thoại</h6>
                <input type="number" class="form-control" id="" placeholder="Nhập vào số điện thoại" name="sdt">
            </div>
            ...
            <div class="form-group">
            	...
            	<div class="form-check form-check-inline">
				  <input class="form-check-input" type="radio" id="inlineRadio1" value="Nam" name="gioitinh">
				  <label class="form-check-label" for="inlineCheckbox1">Nam</label>
				</div>
				<div class="form-check form-check-inline">
				  <input class="form-check-input" type="radio" id="inlinRadio2" value="Nữ" name="gioitinh">
				  <label class="form-check-label" for="inlineCheckbox2">Nữ</label>
				</div>
				<div class="form-check form-check-inline">
				  <input class="form-check-input" type="radio" id="inlineRadio3" value="Khác" name="gioitinh" >
